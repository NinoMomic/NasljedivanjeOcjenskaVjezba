...
namespace Nasljedivanje_samostalni_rad
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Apsolutna vrijednost 1. broja je: "+ x.apsVrijednost());
            Console.WriteLine("Apsolutna vrijednost 2. broja je: " + y.apsVrijednost());
            Console.WriteLine("Apsolutna vrijednost 3. broja je: " + z.apsVrijednost());
